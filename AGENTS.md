...
- Managed sampling uses a configurable inference zoom plus a lower/equal validation zoom. Keep parameters meter-based, not raw-pixel-only, so behavior stays comparable across zoom levels.
