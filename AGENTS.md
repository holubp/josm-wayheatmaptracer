...
- Managed candidate safety gates must stay conservative: reject sparse evidence, long no-signal gaps, edge-of-band candidates, failed lower-zoom validation, self-intersections, and large low-support displacement on normal existing ways.
