...
- Experimental detector variants such as `hot-corridor`, `bluered-cool`, `bluered-corridor`, `dual-corridor`, `gray-strict`, and `purple-strict` are for visual rating and calibration. Keep baseline detector behavior available so user-rated examples can be compared against the old candidates.
