...
- Managed sampling defaults to stable fixed-scale inference: primary ridge extraction must use a normalized effective scale, with higher-resolution source tiles used for validation/refinement. Do not make raw high-resolution tiles the default ridge input again without fixture coverage proving stable behavior.
