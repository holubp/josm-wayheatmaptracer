...
- Saturated broad corridors should be centered using their high-intensity core before ridge tracking. Longitudinal smoothing should suppress high-frequency shoulder aliasing without flattening sustained low-frequency curvature or switchbacks; cover both behaviors in `HeatmapFixtureArchiveTest` and `RidgeTrackerTest`.
